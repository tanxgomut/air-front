      ...
      >
        <v-container class="py-0">
          <v-toolbar class="h-auto d-flex">
            <BlueWhiteLogo />
            <v-list
              class="d-md-flex d-none flex-wrap py-0 ml-4 menu text-capitalize justify-center w-100"
            >
              <!---Menu Loop -->
              <template v-for="(item, i) in sidebarItem">
                <!---Item Sub Header -->
            ...
            <Menu2Icon
              class="d-md-none d-flex drawer-icon drawer-icon no-effect ml-auto mr-0 text-surface"
